...
import { DatosPersonalesForm } from "./info-atleta/DatosPersonalesForm";
import { RedesSocialesForm } from "./info-atleta/RedesSocialesForm";
import { DatosNacimientoForm } from "./info-atleta/DatosNacimientoForm";
    ...
    >
      {({ errors, touched }) => (
        <Form>
          <div className="">
            {/* * datps principales */}
            <DatosPersonalesForm errors={errors} touched={touched} />

            {/* * redes sociales */}
            <RedesSocialesForm errors={errors} touched={touched} />
