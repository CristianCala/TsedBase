...
const UsuarioAtletaYColaborador = () => {
		...
		<nav className=" px-2 sm:px-4 py-1.5 sm:py-2 fixed w-full z-40 top-0 left-0 background-nv z-50">
	        ...
	        <div className="hidden w-full md:block md:w-auto" id="navbar-default">
	            <ul className=" flex flex-col p-4 mt-4 bg-[#141414] rounded-lg md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 md:bg-[#141414] ">
		            ...
		            <li>
		                <button type="button" onClick={e => setUserConfig(!userConfig)} className=" block py-2 pr-8 pl-7 font-medium text-white rounded hover:bg-gray-100 md:hover:text-blue-700 md:p-0 transition ease-in-out delay-150" aria-controls="dropdown-example" data-collapse-toggle="dropdown-example">
			            	...
			            	<ul id="dropdown-example" className={`${userConfig ? `visible` : `hidden py-2 space-y-2`}`}>
...
export default UsuarioAtletaYColaborador