...
import {reporteAtletasVacunadosCovid19PorDisciplina} from '../redux/features/consultasSlice'
import {Formik, Field, Form, ErrorMessage} from 'formik'
import * as Yup from 'yup'

const ReporteAtletasVacunadosCovid19PorDisciplina = () => {
	...
	const handleSubmit = (valores) => {
		console.log(valores)
		setEnviar(true)
		dispatch(reporteAtletasVacunadosCovid19PorDisciplina(valores))
		setTimeout(() => {
	...
	return (
		...
		<section className="max-w-4xl p-6 mx-auto bg-white rounded-md shadow-md dark:bg-gray-800">
		    <h2 className="text-lg font-semibold text-gray-700 capitalize dark:text-white">Reporte de Atletas Vacunados COVID 19 Por Disciplina</h2>
		    ...
		    >
			    <Form>
			        <div className="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2">
			            <div>
			                <label className="text-gray-700 dark:text-gray-200" htmlFor="username">Actividad Deportiva</label>
			                <Field 
			                	id="" 
			                	type="text"
			                	name="actividad" 
...
export default ReporteAtletasVacunadosCovid19PorDisciplina