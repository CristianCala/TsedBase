...
export const ReporteAtletasPorRepresentante = () => {
  ...
  const formSchema = Yup.object().shape({
    representante: Yup.number().required("El campo es obligatorio."),
  });

  function handdleSubmit(e) {
    navigate("/reportes/atletas-por-representantes-deportivos/info");
  }
            ...
            <Form>
              <div className="bg-[#E8E8E8] p-2 md:p-5 m-auto max-w-[700px] md:flex flex-wrap">
                ...
                <div className="md:w-1/2 p-3">
                  <Field name="representante">
                    {({
                      ...
                      return (
                        ...
                        >
                          <option value="">Seleccionar Representantes</option>
                  ...
                  {errors.representante && touched.representante ? (
                    <ErrorMessageInput msg={errors.representante} />
                  ) : null}
                </div>
