...
export const ReporteAtletaVacunados = () => {
  const type_form = {
  ...
  function handdleSubmitAtleta(e) {
    navigate("/reportes/reporte-atletas-vacunados/info");
  }

  function handdleSubmitDisciplina(e) {
    navigate("/reportes/reporte-atletas-disciplina-vacunados/info");
  }
      ...
      <GraySection>
        <div className="text-[#693CBA] text-center font-extrabold">
          <h2 className=" lg:text-3xl text-2xl mb-10">
            Reporte Atletas Vacunados Covid 19
          </h2>
        </div>
