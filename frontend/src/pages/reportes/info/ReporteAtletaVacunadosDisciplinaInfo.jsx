...
export const ReporteAtletaVacunadosDisciplinaInfo = () => {
  ...
  const inputsFilter = [
    {
      id: "primera_dosis",
      label: "Total Atletas vacunados primera dosis",
      value: 32,
    },
    {
      id: "segunda_dosis",
      label: "Total Atletas vacunados segunda dosis",
      value: 32,
    },
    {
      id: "tercera_dosis",
      label: "Total Atletas vacunados tercera dosis",
      value: 32,
    },
    {
      id: "cuarta_dosis",
      label: "Total Atletas vacunados cuarta dosis",
      value: 32,
    },
  ];
            ...
            return (
              <div className="flex gap-[9px] items-center">
                <input
                  ...
                  id={filtro.id}
                />
                <label className="cursor-pointer" htmlFor={filtro.id}>
