...
export const ReporteAtletasIndumentariaInfo = () => {
              ...
              <tbody class="[&>*:nth-child(even)]:bg-[#EBDFFF]">
                {info_table.map((data, i) => (
                  ...
                  >
                    ...
                    <td class="py-4 px-6">{data.sexo}</td>
                    <td class="py-4 px-6">{data.talla_pantalon}</td>
                    <td class="py-4 px-6">{data.talla_short}</td>
                    <td class="py-4 px-6">{data.talla_calzado}</td>
                    <td class="py-4 px-6">{data.talla_chaqueta}</td>
                  </tr>
                ))}
              </tbody>
            </table>
