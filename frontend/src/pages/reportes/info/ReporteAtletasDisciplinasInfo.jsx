...
import {
  add_aditional_data_fake,
  atletas_disciplina,
} from "../../../utils/helpers/dataFakeRecord";
import Images from "../../../utils/images/images";

export const ReporteAtletasDisciplinasInfo = () => {
            ...
            <table class="text-center w-full text-sm  font-bold ">
              <thead class="text-xs uppercase bg-[#693CBA] text-white">
                <tr>
                  ...
                  <th scope="col" class="py-4 px-6">
                    Total de atletas por disciplina
                  </th>
                </tr>
              </thead>
              <tbody class="[&>*:nth-child(even)]:bg-[#EBDFFF]">
                {info_table.map((data, i) => (
                  ...
                  >
                    ...
                    <td class="py-4 px-6">
                      {Math.round(data.num_cedula / 32332)}
                    </td>
                  </tr>
                ))}
              </tbody>
