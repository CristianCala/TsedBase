...
export const ReporteAtletaPasaporteEstatusAtletaInfo = () => {
      ...
      <GraySection>
        ...
        <div className=" text-[#693CBA] font-extrabold flex items-center mb-10 gap-[20px]">
          ...
          <h2 className=" lg:text-3xl text-2xl">
            Reporte Estatus de vigencia de pasaporte de Atleta
          </h2>
        </div>
        ...
        <div className="mb-10">
          <div className="flex gap-[9px] items-center">
            <input
              className="w-4 h-4 text-[#693CBA]  focus:ring-[#693CBA]"
              type="radio"
              name="passport"
              id="passport_vigente"
            />
            <label className="cursor-pointer" htmlFor="passport_vigente">
              Total pasaportes vigentes: <strong>54</strong>
            </label>
          </div>
          <div className="flex gap-[9px] items-center">
            <input
              ...
              id="passport_vencido"
            />
            <label className="cursor-pointer" htmlFor="passport_vencido">
              Total pasaportes vencidos:: <strong>4</strong>
            </label>
          </div>
          <div className="flex gap-[9px] items-center">
            <input
              ...
              id="passport_6_meses"
            />
            <label className="cursor-pointer" htmlFor="passport_6_meses">
              Total pasaportes con menos de 6 meses de vigencia::{" "}
              <strong>54</strong>
            </label>
          </div>
        </div>
              ...
              <tbody class="[&>*:nth-child(even)]:bg-[#EBDFFF]">
                {info_table.map((data, i) => (
                  ...
                  >
                    ...
                    <td class="py-4 px-6">{data.pasaporte_status}</td>
                  </tr>
                ))}
              </tbody>
            </table>
