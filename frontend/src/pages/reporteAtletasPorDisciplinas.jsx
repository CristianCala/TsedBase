  ...
  return (
    <section className="max-w-4xl p-6 mx-auto bg-white rounded-md shadow-md dark:bg-gray-800">
      <h2 className="text-lg font-semibold text-gray-700 capitalize dark:text-white">
        Reporte de Atletas Por Disciplina
      </h2>
      ...
      >
        <Form>
            ...
            <div>
              ...
              >
                <option selected defaultValue="10">
                  Selecionar la cantidad de registros
                </option>
            ...
            <div>
              ...
              <Field
                ...
                className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg 
								...
								dark:focus:border-blue-500"
              >
                <option selected defaultValue="Predeterminado">
                  Selecionar como desea ordenar los registros
                </option>
                <option value="Predeterminado">Predeterminado</option>
                <option value="Ascendente">Ascendente</option>
                <option value="Descendente">Descendente</option>
                <option value="DisciplinaAscendente">
                  Disciplina Ascendente
                </option>
                <option value="DisciplinaDescendente">
                  Disciplina Descendente
                </option>
                <option value="Cédula">Cédula</option>
                <option value="CédulaAscendente">Cédula Ascendente</option>
                <option value="CédulaDescendente">Cédula Descendente</option>
                <option value="certificadoDeNacimiento">
                  certificado de nacimiento
                </option>
                <option value="certificadoDeNacimientoAscendente">
                  certificado de nacimiento Ascendente
                </option>
                <option value="certificadoDeNacimientoDescendente">
                  certificado de nacimiento Descendente
                </option>
              </Field>
            </div>
          </div>
          ...
          <div className="flex justify-between mt-6">
            <button
              type="submit"
              className="inline-flex items-center py-2.5 px-4 text-md font-medium text-center text-white bg-blue-700 rounded-lg bg-gradient-to-bl from-[#9662F1] to-[#673AB7] hover:bg-gradient-to-br focus:ring-2 focus:outline-none focus:ring-purple-300"
            >
              Consultar
            </button>
            <Link
