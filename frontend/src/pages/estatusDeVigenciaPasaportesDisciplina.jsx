...
import {estatusDeVigenciaPasaportesAtletasDisciplina} from '../redux/features/consultasSlice'
import {Formik, Field, Form, ErrorMessage} from 'formik'
import * as Yup from 'yup'

const EstatusDeVigenciaPasaportesDisciplina = () => {
	...
	const handleSubmit = (valores) => {
		console.log(valores)
		setEnviar(true)
		dispatch(estatusDeVigenciaPasaportesAtletasDisciplina(valores))
		setTimeout(() => {
	...
	return (
		...
		<section className="max-w-4xl p-6 mx-auto bg-white rounded-md shadow-md dark:bg-gray-800">
		    <h2 className="text-lg font-semibold text-gray-700 capitalize dark:text-white">Estatus de vigencia de pasaportes por disciplina</h2>
...
export default EstatusDeVigenciaPasaportesDisciplina